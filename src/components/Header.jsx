...
//             <Link to='/'>
//               <img src="https://texnomart.uz/_nuxt/img/texnomart-logo.3b2791c.svg" alt="" />
//             </Link>

//             <Link to="/categories">
//               <button className="katalog">
//                 <img src="/images/menu-regular-24.png" width={24} height={24} alt="" />
//                 {langContent.catalog}
//               </button>
//             </Link>
...
//                 <Search />
//               </button>
//               <input type="text" placeholder={langContent.searchPlaceholder} />
//             </div>
